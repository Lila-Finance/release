...
const VariableEarningPopup = ({
  getBalance,
  approveDaiF,
  supplyDaiF,
  isLoadingAllow,
  setdaiManout,
  backToChooseScreenVaribale,
  pools,
  selected_pool
}) => {
  ...
  const clickSupplyDai = async () => {
    ...
    const wentthrough = await supplyDaiF(pools[selected_pool][0], daiAmount, false);
  };
  ...
  return (
    ...
    >
      ...
      <div className="w-full flex items-center justify-between">
        <h2 className="font-bold text-xl md:text-2xl lg:text-[27px] xl:text-2xl">
          Earn Variable on Dai AAVE 1 Week
        </h2>

        <button
          className="text-lg lg:text-xl bg-themeColor py-[6px] px-10 rounded-[15px] drop-shadow-buttonShadow hover:-translate-x-2 duration-200"
          onClick={backToChooseScreenVaribale}
        >
          Back
        </button>
      </div>
        ...
        >
          ...
          <div className="mt-6">
            ...
            <div className="w-full mt-2">
              ...
              <p className="text-lg lg:text-2xl font-semibold">{pools[selected_pool][5]-pools[selected_pool][4]}</p>
            </div>
          </div>
...
export default VariableEarningPopup;
